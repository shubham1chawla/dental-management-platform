...
urlpatterns = [
    ...
    path('clinics/<int:clinic_id>/affiliations/add', view=views.get_add_affiliations_page, name='Add Affiliations Page'),
    path('clinics/<int:clinic_id>/affiliations/<int:doctor_id>/update', view=views.get_update_affiliations_page, name='Update Affiliations Page'),
